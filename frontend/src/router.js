    ...
    render(){
        return(
            <div>
                ...
                <Route exact={true} path='/clientes' component={() => <Clientes infoModal={(info) => this.props.infoModal(info)} rotaAtual={(rota) => this.props.rotaAtual(rota)} pegandoDadosServidor={(dados) => this.props.pegandoDadosServidor(dados)} controlarPaginacaoCliente={(pagina) => this.props.controlarPaginacaoCliente(pagina)} clientesDados={this.props.clientesDados} />} />

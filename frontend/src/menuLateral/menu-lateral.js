                    ...
                    <nav>
                        <ul>
                            <Link className='text-decoration-none' to='/'  onClick={() => this.ativarMenu('#agenda', '#liAgenda')}>
                                <div id='agenda' className='ativo'></div> <li className='liAtivo' id='liAgenda'> <i className="far fa-calendar-alt fa-lg"></i> &nbsp; <span> AGENDA </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/vendas' onClick={() => this.ativarMenu('#venda', '#liVenda')}>
                                <div id='venda'></div> <li id='liVenda'> <i className="fas fa-shopping-cart fa-lg"></i> &nbsp; <span> VENDAS </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/estoque' onClick={() => this.ativarMenu('#estoque', '#liEstoque')}> 
                                <div id='estoque'></div><li id='liEstoque'> <i className="fas fa-box-open fa-lg"></i> &nbsp; <span> ESTOQUE </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/clientes' onClick={() => this.ativarMenu('#cliente', '#liCliente')}>
                                <div id='cliente'></div> <li id='liCliente'> <i className="fas fa-users fa-lg"></i> &nbsp; <span> CLIENTES </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/ordem-de-servico' onClick={() => this.ativarMenu('#ordemServico', '#liOrdemServico')}>
                                <div id='ordemServico'></div> <li id='liOrdemServico'> <i className="fas fa-toolbox fa-lg"></i> &nbsp; <span> ORDEM DE SERVIÇO </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/funcionarios' onClick={() => this.ativarMenu('#funcionarios', '#liFuncionarios')}>
                                <div id='funcionarios'></div> <li id='liFuncionarios'> <i className="fas fa-user-tie fa-lg"></i> &nbsp; <span> FUNCIONARIOS </span> </li>
                            </Link>
                            <Link className='text-decoration-none' to='/ajuda' onClick={() => this.ativarMenu('#ajuda', '#liAjuda')}>
                                <div id='ajuda'></div> <li id='liAjuda'> <i className="fas fa-question-circle fa-lg"></i> &nbsp; <span> AJUDA </span> </li>
                            </Link>
                        </ul>
                    </nav>
                </div>
